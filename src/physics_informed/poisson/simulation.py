...
for x_branch0 in x_test[0]:
    ...
    x_branch = tomo_output(20,20, x_branch, branch_hidden4_thetas,simulator)+branch_hidden4_bias
    x_branch = tanh(x_branch)
    
    x_branch = tomo_output(20,20, x_branch, branch_hidden5_thetas,simulator)+branch_hidden5_bias
    x_branch = tanh(x_branch)
...
for x_trunk in x_test[1]:
    ...
    x_trunk = tomo_output(20,20, x_trunk, trunk_hidden4_thetas,simulator)+trunk_hidden4_bias
    x_trunk = tanh(x_trunk)
    
    x_trunk = tomo_output(20,20, x_trunk, trunk_hidden5_thetas,simulator)+trunk_hidden5_bias
    x_trunk = tanh(x_trunk)
...
np.savetxt(r'simulation_error_1.0.txt',[mean_l2_error])
